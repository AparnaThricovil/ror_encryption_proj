class MastersController < ApplicationController
  before_action :set_master, only: [:show, :edit, :update, :destroy, :encrypt]
  ...
  def create
    ...
    respond_to do |format|
      if @master.save
        ...
        format.json { render action: 'show', status: :created, location: @master }
      else
  ...
  private
    ...
    def master_params
      params.require(:master).permit(:username, :email, :password, :password_confirmation, :publickey, :privatekey)
    end
end
